...
trong CMD để dừng từ phía launcher; giao diện sẽ tự đóng nếu trình duyệt cho phép,
hoặc hiện màn hình xác nhận ứng dụng đã dừng. Khi đang có job tạo report, hãy hủy
hoặc chờ job hoàn tất trước khi kết thúc phiên.
