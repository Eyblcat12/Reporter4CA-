...
from core.rule_engine import assessment_text, evaluate_asset, evaluate_payload, find_rule_conflicts, load_rule_pack, validate_rule
...
class RuleEngineTests(unittest.TestCase):
    ...
    def test_rule_can_be_disabled_by_preset_configuration(self) -> None:
        ...
        self.assertEqual(result["clients"][0]["findings"], [])
