...
def refresh_docx_fields(
    ...
    *,
    ...
    try:
        ...
        # a template-derived document. The script rebuilds TOCs first, then we
        # restore the normal update-on-open safety flag before committing.
        ...
        _set_update_fields_on_open(working_copy, enabled=True)
